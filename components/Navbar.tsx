        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              >
                <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                  <BookOpen className="h-4 w-4 md:h-5 md:w-5 text-white" />
                  <motion.div
                    className="absolute -top-0.5 -right-0.5 md:-top-1 md:-right-1 w-2.5 h-2.5 md:w-3 md:h-3 bg-yellow-400 rounded-full flex items-center justify-center"
              ...
              <div className="flex flex-col">
                <motion.span
                  className="text-lg md:text-xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent"
            ...
            {/* Mobile Menu Toggle */}
            <motion.button
              className="md:hidden relative p-2 rounded-lg md:rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-200"
              onClick={toggleMenu}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              initial={{ opacity: 0, scale: 0.8 }}
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  {isOpen ? 
                    <X className="h-5 w-5 md:h-6 md:w-6 text-gray-700 dark:text-gray-200" /> : 
                    <Menu className="h-5 w-5 md:h-6 md:w-6 text-gray-700 dark:text-gray-200" />
                  }
                </motion.div>
              </AnimatePresence>
            </motion.button>
            ...
            >
              <div className="container mx-auto px-4 py-4 md:py-6">
                  ...
                  {navLinks.map((link, index) => (
                    ...
                    >
                      <motion.a
                        href={link.href}
                        onClick={closeMenu}
                        className="flex items-center gap-3 p-3 md:p-4 rounded-xl md:rounded-2xl text-gray-700 dark:text-gray-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-300 group"
                        whileHover={{ x: 8, scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        <div className="text-lg md:text-xl group-hover:scale-110 transition-transform duration-200">
                          {link.icon}
                        </div>
                        <div className="flex-1">
                          <div className="font-semibold text-base md:text-lg">{link.label}</div>
                ...
                >
                  {/* Web App Button */}
                  <motion.button
                    className="w-full group relative overflow-hidden bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-xl md:rounded-2xl p-3 md:p-4 shadow-lg hover:shadow-xl transition-all duration-300"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-base md:text-lg font-bold">Web App</div>
                        </div>
                      </div>
                      <motion.div
                        animate={{ rotate: 360 }}
